          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <h1 className="text-6xl">
                Soy{" "}
                <span className="text-blue-400 text-7xl">Jaider Ramirez</span>
              ...
              <div className="flex pt-9 gap-4">
                <Link href="/projects" className="rounded-3xl">
                  <Button className="text-2xl h-12 w-44 pb-2.5 px-5 cursor-pointer rounded-3xl border border-blue-500 hover:bg-blue-100">
                    Proyectos
                  </Button>
                </Link>
                <Link href="/contact" className="rounded-3xl">
                  <Button className="bg-blue-500 hover:bg-blue-600 cursor-pointer text-white text-2xl h-12 w-44 pb-2.5 px-5 rounded-3xl">
                    Contactame
                  </Button>
                </Link>
              </div>
